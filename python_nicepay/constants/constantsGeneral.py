class ConstantsGeneral:
    ...
    _DB_PROCESS_URL = "https://webhook.site/8be2ddd0-75fd-4954-8e3d-7c13d22f17d9"
    _USER_IP = "127.0.0.1"
    _USER_SESSION_ID = ""
    _USER_AGENT = ""
    _USER_LANGUAGE = ""
