class ConvenienceStoreV1:
    ...
    def jsonConvenienceStoreV1(self):
        return ({
...
class BuilderConvenienceStoreV1:
    def __init__(self):
        self.payMethod = None
        self.bankCd = None
...
class BuildConvenienceStoreV1(BuilderConvenienceStoreV1):
    def build(self):
        return ConvenienceStoreV1(
            self.payMethod,
            self.mitraCd,
            self.payValidDt,
            self.payValidTm,
